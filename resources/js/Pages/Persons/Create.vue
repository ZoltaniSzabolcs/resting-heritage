...
const form = useForm({
    grave_id: usePage().props.grave.id,
    first_name: '',
    last_name: '',
    initials: '',
    birth_date: null,
        ...
        <div class="max-w-4xl mx-auto p-6">
            ...
            <nav class="mb-6 text-sm text-gray-500">
                <ol class="list-reset flex">
                    <li>
                        <Link :href="route('persons.index')" class="hover:text-blue-600">Persons</Link>
                    </li>
            ...
            <!-- Title -->
            <h1 class="text-2xl font-semibold mb-6">Create Person</h1>
            <h3 class="font-semibold mb-6"> Linked to grave {{ grave.name }}</h3>
            ...
            <div class="bg-white rounded-lg shadow p-6">
              ...
              form.errors.name
                ...
                : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                    ...
                    <div>
                        ...
                        <input v-model="form.initials" type="text"
                               :class="[
              'mt-1 block w-full rounded-md shadow-sm sm:text-sm',
              form.errors.name
                ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                    ...
                    <div>
                        ...
                        <input v-model="form.birth_date" type="date"
                               :class="[
              'mt-1 block rounded-md shadow-sm sm:text-sm',
              form.errors.name
                ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
            ]"/>
              ...
              form.errors.name
                ...
                : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                    ...
                    <!-- Death place -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Death Place</label>
                        <input v-model="form.death_place" type="text"
                               :class="[
              'mt-1 block w-full rounded-md shadow-sm sm:text-sm',
              form.errors.name
                ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                        ...
                        <InputError :message="form.errors.death_place"/>
                    </div>
